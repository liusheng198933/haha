...
class OFPBundleCtrlMsg(MsgBase):
    ...
    Example::
        ...
        def send_bundle_control(self, datapath):
            ...
            datapath.send_msg(req)
    """
    def __init__(self, datapath, bundle_id=0, type_=None, flags=None, properties=None):
...
class OFPBundleAddMsg(MsgInMsgBase):
    ...
    Example::
        ...
        def send_bundle_add_message(self, datapath):
            ...
            datapath.send_msg(req)
    """
    def __init__(self, datapath, bundle_id=0, flags=None, message=None, properties=None):
